...
public class NaverApiService {
    ...
    public List<ItemDto> searchItems(String query) {
        ...
        headers.add("X-Naver-Client-Id", "3TW20dVRdYHPlf25qrj2"); // 내 naver developers 계정에서 받은 아이디
        headers.add("X-Naver-Client-Secret", "941vILt3ep"); // 내 naver developers 계정에서 받은 시크릿
        String body = "";
        ...
        HttpStatus httpStatus = (HttpStatus) responseEntity.getStatusCode(); // 여기 오류떠서 수정함
